...
<title>Mihstore A Ecommerce Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<link href="template/frontend-users/4/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="template/frontend-users/4/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="template/frontend-users/4/css/style.css" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<script type="text/javascript" src="template/frontend-users/4/js/move-top.js"></script>
<script type="text/javascript" src="template/frontend-users/4/js/easing.js"></script>
...
<!-- start menu -->
<link href="template/frontend-users/4/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="template/frontend-users/4/js/megamenu.js"></script>
...
<!--header-->
	<div class="container">
		...
		<div class="header-top">
			<div class="logo">
				<a href="index.html"><img src="template/frontend-users/4/images/logo.png" alt="" ></a>
			</div>
						  ...
						  <div class="shopping_cart">
							  <div class="cart_box">
							   	 <div class="message">
										...
										<div class="list_img"><img src="template/frontend-users/4/images/si.jpg" class="img-responsive" alt=""></div>
	                           ...
	                           <div class="cart_box">
							   	 <div class="message1">
										...
										<div class="list_img"><img src="template/frontend-users/4/images/si1.jpg" class="img-responsive" alt=""></div>
										<div class="list_desc"><h4><a href="#">velit esse molestie</a></h4>
		...
		<div class="content">
			...
			<div class="col-md-9">
			<div class="shoe">
				<img class="img-responsive" src="template/frontend-users/4/images/banner.jpg" alt="" >
				<div class="shop">
				...
				<div class="content-bottom">
					...
					<div class="bottom-grid">
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh.png" alt="" >
								<div class="five">
									<h6 >-50%</h6>
								</div>
								<div class="pre">
						...
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh2.png" alt="" >
								<div class="five">
								<h6 class="one" >-50%</h6>
								</div>
								<div class="pre">
						...
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh1.png" alt="" >
								<div class="five">
								<h6 class="one1" >-50%</h6>
								</div>
								<div class="pre">
					...
					<div class="bottom-grid">
						...
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh3.png" alt="" >
								<div class="five">
								<h6 class="one1">-50%</h6>
								</div>
								<div class="pre">
						...
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh4.png" alt="" >
								<div class="five">
								<h6 >-50%</h6>
								</div>
								<div class="pre">
					...
					<div class="bottom-grid">
						<div class="col-md-4 shirt">
							<div class="bottom-grid-top">
								<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/sh5.png" alt="" >
								<div class="five">
								<h6 class="one1">-50%</h6>
								</div>
								<div class="pre">
			...
			<div class=" possible-about">
					<h4>Sort Products</h4>
						<div class="tab1">
							<ul class="place">
								...
								<li class="by"><img src="template/frontend-users/4/images/do.png" alt=""></li>
									<div class="clearfix"> </div>
							</ul>
				...
				<li><a class="color10" href="#"></a></li>
					...
					<div class="latest-grid">
						<div class="news">
							<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/si.jpg" title="name" alt=""></a>
						</div>
						<div class="news-in">
				...
				<div class="latest-grid">
						<div class="news">
							<a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/si1.jpg" title="name" alt=""></a>
						</div>
						<div class="news-in">
							<h6><a href="single.html">Product name here</a></h6>
							<p>Description Lorem ipsum </p>
				...
				<div class="money">
					<h3>Payment Options</h3>
						<ul class="money-in">
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p1.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p2.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p3.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p4.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p5.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p6.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p1.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p4.png" title="name" alt=""></a></li>
						<li><a href="single.html"><img class="img-responsive" src="template/frontend-users/4/images/p2.png" title="name" alt=""></a></li>
