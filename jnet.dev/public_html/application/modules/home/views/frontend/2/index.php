...
<link href="template/frontend-users/2/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="template/frontend-users/2/css/docs.min.css" rel="stylesheet">
<!-- Custom Theme files -->
<!--theme style-->
<link href="template/frontend-users/2/css/style.css" rel="stylesheet" type="text/css" media="all" />	
<script src="template/frontend-users/2/js/jquery.min.js"></script>
...
<!-- start menu -->
<script src="template/frontend-users/2/js/simpleCart.min.js"> </script>
<!-- start menu -->
<link href="template/frontend-users/2/css/memenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="template/frontend-users/2/js/memenu.js"></script>
<script>$(document).ready(function(){$(".memenu").memenu();});</script>	
<!-- /start menu -->
</head>
<body> 
<!--header-->	
<script src="template/frontend-users/2/js/responsiveslides.min.js"></script>
<script>  
    $(function () {
...
<!---->
<script src="template/frontend-users/2/js/bootstrap.js"> </script>

<div class="items">
	 <div class="container">
		 <div class="items-sec">
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img1.jpg" alt=""/>	
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img2.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 10000</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img3.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 8500</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img4.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 12000</p>
						 <span class="pric1"><del>Rs 18000</del></span>
		 ...
		 <div class="items-sec btm-sec">
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img5.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 500</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img8.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 400</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img7.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 800</p>
			 ...
			 <div class="col-md-3 feature-grid">
				 <a href="product.html"><img src="template/frontend-users/2/images/img6.jpg" alt=""/>	
					 <div class="arrival-info">
						 <h4>Lighting #1</h4>
						 <p>Rs 600</p>
						 <span class="pric1"><del>Rs 1200</del></span>
	 ...
	 <div class="offer-grids">
		 <div class="col-md-6 grid-left">
			 <a href="#"><div class="offer-grid1">
				 <div class="ofr-pic">
					 <img src="template/frontend-users/2/images/ofr2.jpeg" class="img-responsive" alt=""/>
				 </div>
		 ...
		 <div class="col-md-6 grid-right">
			 <a href="#"><div class="offer-grid2">				 
				 ...
				 <div class="ofr-pic2">
					 <img src="template/frontend-users/2/images/ofr3.jpg" class="img-responsive" alt=""/>
				 </div>
				 <div class="clearfix"></div>
			 </div></a>
		 </div>
