...
<title>Markito A Ecommerce Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<link href="template/frontend-users/3/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="template/frontend-users/3/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="template/frontend-users/3/css/style.css" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<script type="text/javascript" src="template/frontend-users/3/js/move-top.js"></script>
<script type="text/javascript" src="template/frontend-users/3/js/easing.js"></script>
...
<!-- start menu -->
<link href="template/frontend-users/3/css/megamenu.css" rel="stylesheet" type="text/css" media="all" />
<script type="text/javascript" src="template/frontend-users/3/js/megamenu.js"></script>
<script>$(document).ready(function(){$(".megamenu").megamenu();});</script>

<script src="template/frontend-users/3/js/simpleCart.min.js"> </script>
</head>
<body> 
<!--header-->	
<div class="header" >
	<div class="top-header" >		
		...
		<div class="head-top">
			<div class="logo">
				<a href="index.html"><img src="template/frontend-users/3/images/logo.png" alt="" ></a>
			</div>
		<div class="top-nav">		
							...
							<div class="col1">
								<div class="h_nav">
									<ul>
										...
										<li><a href="mobile.html">Huawei lumia</a></li>
				  ...
				  <div class="megapanel">
					...
					<div class="cart box_1">
						...
						<h3> <div class="total">
							...
							<img src="template/frontend-users/3/images/cart.png" alt=""/></h3>
						</a>
						<p><a href="javascript:;" class="simpleCart_empty"><img src="template/frontend-users/3/images/cart-c.png"  alt=""></a></p>
						<div class="clearfix"> </div>
					</div>
...
<div class="container">	
		  <div class="wmuSlider example1">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
				   	<div class="banner-wrap">
						...
						<div class="banner-top-in">
							<img src="template/frontend-users/3/images/ba.png" class="img-responsive" alt="">
						</div></a>
						...
						<div class="banner-top-in at">
							<img src="template/frontend-users/3/images/ba2.png" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<a href="single.html">
						<div class="banner-top-in">
							<img src="template/frontend-users/3/images/ba11.png" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
						...
						<div class="clearfix"> </div>
						  ...
						  <a href="single.html">
						<div class="banner-top-in at">
							<img src="template/frontend-users/3/images/ba21.png" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
			 ...
			 <article style="position: absolute; width: 100%; opacity: 0;"> 
						...
						<a href="single.html">
						<div class="banner-top-in">
							<img src="template/frontend-users/3/images/ba12.png" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
						...
						<div class="clearfix"> </div>
						  ...
						  <a href="single.html">
						<div class="banner-top-in at">
							<img src="template/frontend-users/3/images/ba22.png" class="img-responsive" alt="">
						</div></a>
						<div class="cart-at grid_1 simpleCart_shelfItem">
								<div class="item_add"><span class="item_price" >123 $ <i> </i> </span></div>
							<div class="off">
		...
		<!---->
		  <script src="template/frontend-users/3/js/jquery.wmuSlider.js"></script> 
			  <script>
       			$('.example1').wmuSlider({
					 pagination : true,
					 nav : false,
...
<div class="content">
	<div class="container">
		...
		<link href="template/frontend-users/3/css/owl.carousel.css" rel="stylesheet">
		<script src="template/frontend-users/3/js/owl.carousel.js"></script>
			<script>
		...
		<!-- //requried-jsfiles-for owl -->
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="template/frontend-users/3/images/pi.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="template/frontend-users/3/images/pi11.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="template/frontend-users/3/images/pi12.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="template/frontend-users/3/images/pi13.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
	...
	<div class="content-middle">
		...
		<div class="col-best">
			<div class="col-md-4">
				<a href="single.html"><div class="col-in">
					<div class="col-in-left">
						<img src="template/frontend-users/3/images/ni.jpg" class="img-responsive" alt="">
					</div>
					</a>
			...
			<div class="col-md-4">
				<a href="single.html"><div class="col-in">
					<div class="col-in-left">
						<img src="template/frontend-users/3/images/ni1.jpg" class="img-responsive" alt="">
					</div>
					</a>
					<div class="col-in-right grid_1 simpleCart_shelfItem">
						<h5>fuel t-shirt  mod : 9509</h5>
	...
	<div class="bottom-content">
			...
			<div class="col-md-4">
				<img src="template/frontend-users/3/images/ad1.png" class="img-responsive" alt="">
			</div>
			<div class="col-md-4">
				<img src="template/frontend-users/3/images/ad1.png" class="img-responsive" alt="">
			</div>
