...
<header role="banner">
				...
				<!--header bottom part-->
				<section class="h_bot_part container content">
						...
						<div class="col-lg-6 col-md-6 col-sm-8 t_align_r t_xs_align_c">
							<ul class="d_inline_b horizontal_list clearfix t_align_l site_settings">
								...
								<li class="d_sm_none d_xs_block">
									...
									<a role="button" href="#" data-popup="#login_popup" class="button_type_1 color_dark d_block bg_light_color_1 r_corners tr_delay_hover box_s_none"><i class="fa fa-user f_size_ex_large"></i></a>
								...
								<li class="relative f_xs_none m_xs_bottom_5"><a href="features_shortcodes.html" class="tr_delay_hover color_light tt_uppercase"><b>Features</b></a>
									...
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
                                            ...
                                            <li class="relative f_xs_none m_xs_bottom_5"><a class="color_dark tr_delay_hover" href="#">3rd Menu Level</a>
                                            	<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
                                                	<ul class="sub_menu">
														<li><a class="color_dark tr_delay_hover" href="#">Item 1</a></li>
														<li><a class="color_dark tr_delay_hover" href="#">Item 2</a></li>
                                            			<li><a class="color_dark tr_delay_hover" href="#">Item 3</a></li>
													</ul>
                                                </div>
                                            </li>
										</ul>
