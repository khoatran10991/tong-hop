							...
							<div class="col-lg-4 col-md-4 col-sm-3 t_align_r t_xs_align_c">
								...
								<ul class="horizontal_list clearfix d_inline_b t_align_l f_size_small site_settings type_2">
									...
									<li class="container3d relative">
										...
										<a role="button" href="#" class="color_dark" id="lang_button"><img class="d_inline_middle m_right_10" src="<?php echo $global['_path'] ?>/images/flag_en.jpg" alt="">English</a>

										<ul class="dropdown_list type_2 top_arrow color_light">

											<li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo $global['_path'] ?>/images/flag_en.jpg" alt="">English</a></li>

											<li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo $global['_path'] ?>/images/flag_fr.jpg" alt="">French</a></li>

											<li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo $global['_path'] ?>/images/flag_g.jpg" alt="">German</a></li>

											<li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo $global['_path'] ?>/images/flag_i.jpg" alt="">Italian</a></li>

											<li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="<?php echo $global['_path'] ?>/images/flag_s.jpg" alt="">Spanish</a></li>
						...
						<nav role="navigation" class="f_left f_xs_none d_xs_none t_xs_align_l">	
							...
							<?php foreach($global['menu'] as $item):?>
	                            ...
	                            <li class="relative f_xs_none m_xs_bottom_5">
	                                <a class="tr_delay_hover color_light tt_uppercase" href="<?php echo $item->link;?>"><?php echo $item->name;?></a>
	                        	</li>
	                        	<?php endif; ?>	
                       		<?php endforeach;?>	
								...
								<li class="relative f_xs_none m_xs_bottom_5"><a href="category_grid.html" class="tr_delay_hover color_light tt_uppercase"><b>Shop</b></a>
									...
									<div class="sub_menu_wrap top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
										...
										<img src="<?php echo $global['_path'] ?>/images/woman_image_1.jpg" class="d_sm_none f_right m_bottom_10" alt="">
