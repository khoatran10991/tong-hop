...
<link href="template/frontend-users/5/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="template/frontend-users/5/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="template/frontend-users/5/css/style.css" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
...
<!--header-->
	...
	<div class="header">
		<div class="logo">
			<a href="index.html"><img src="template/frontend-users/5/images/logo.png" alt="" ></a>
		</div>
		<div  class="header-top">
			<div class="header-grid">
				<ul class="header-in">
					...
					<!-- search-scripts -->
					<script src="template/frontend-users/5/js/classie.js"></script>
					<script src="template/frontend-users/5/js/uisearch.js"></script>
						<script>
			...
			<div class="header-bottom">
				...
				<script type="text/javascript" src="template/frontend-users/5/js/nav.js"></script>
			</div><!-- end h_menu4 -->
...
<!-- requried-jsfiles-for owl -->
							<link href="template/frontend-users/5/css/owl.carousel.css" rel="stylesheet">
							    <script src="template/frontend-users/5/js/owl.carousel.js"></script>
							        <script>
		...
		<div id="owl-demo" class="owl-carousel text-center">
			<div class="item">
				<a href="single.html" title="image" rel="title1">
					<img class="img-responsive " src="template/frontend-users/5/images/pic.jpg" alt="">
				<div class="run">
					<i> </i>
					<p>RUNNING</p>
				</div>
			...
			<div class="item">
				<a href="single.html" title="image" rel="title1">
					<img class="img-responsive " src="template/frontend-users/5/images/pic1.jpg" alt="">
				<div class="run">
					<i class="foot-in"> </i>
					<p>FOOTBALL</p>
				</div>
			...
			<div class="item">
				<a href="single.html" title="image" rel="title1">
					<img class="img-responsive " src="template/frontend-users/5/images/pic2.jpg" alt="">
				<div class="run">
				<i class="cycling"> </i>
				<p>CYCLING</p>
				</div>
			...
			<div class="item">
				<a href="single.html" title="image" rel="title1">
					<img class="img-responsive " src="template/frontend-users/5/images/pic3.jpg" alt="">
				<div class="run">
				<i class="fitness"> </i>
				<p>FITNESS</p>
				</div>
			...
			<div class="item">
				<a href="single.html" title="image" rel="title1">
					<img class="img-responsive " src="template/frontend-users/5/images/pic4.jpg" alt="">
				<div class="run">
				<i class="tennis"> </i>
				<p>TENNIS</p>
				</div>
	...
	<div class="col-md-4 content-grid">
		<a href="single.html" class="lot"><img class="img-responsive " src="template/frontend-users/5/images/sh.png" alt=""></a>
		<div class="shoe">
	...
	<div class="col-md-4 content-grid">
		<a href="single.html" class="lot"><img class="img-responsive " src="template/frontend-users/5/images/sh1.png" alt=""></a>
		<div class="shoe">
	...
	<div class="col-md-4 content-grid">
		<a href="single.html" class="lot"><img class="img-responsive " src="template/frontend-users/5/images/sh2.png" alt=""></a>
		<div class="shoe">
			<p>Nike 3.0 V4 Men Grey RoyalBlue with White</p>
			<label>$67.99</label>
			<a href="single.html">find a store</a>
	...
	<div class="content-top">
		<div class="col-md-4 top-content">
			<a href="single.html"><img class="img-responsive " src="template/frontend-users/5/images/pi.jpg" alt=""></a>
		</div>
		<div class="col-md-4 top-content">
			<a href="single.html"><img class="img-responsive " src="template/frontend-users/5/images/pi1.jpg" alt=""></a>
		</div>
		<div class="col-md-4 top-content">
			<a href="single.html"><img class="img-responsive " src="template/frontend-users/5/images/pi2.jpg" alt=""></a>
		</div>
	...
	<div class="content-bottom">
		<div class="col-md-8 bottom-content">
			<script src="template/frontend-users/5/js/responsiveslides.min.js"></script>
					<script>
						$(function () {
					...
					<div class="slider">
						<div class="callbacks_container">
						  <ul class="rslides" id="slider">
							<li>
							  <img src="template/frontend-users/5/images/vi.jpg" alt="">
							  
							</li>
							<li>
							  <img src="template/frontend-users/5/images/v2.jpg" alt="">
