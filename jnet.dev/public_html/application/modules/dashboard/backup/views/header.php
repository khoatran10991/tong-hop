     ...
     <!-- Navigation -->
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{url_site}/dashboard.html"><img id="logo" src={layout}></a>
            </div>
            <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/1.png" alt=""/>
								<div>New message</div>
						...
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/2.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
								<span class="label label-info">NEW</span>
							</a>
						...
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/3.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/4.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/5.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
						<li class="avatar">
							<a href="#">
								<img src="template/backend/1/images/pic1.png" alt=""/>
								<div>New message</div>
								<small>1 minute ago</small>
							</a>
						</li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{url_site}/dashboard/library.html"><i class="fa fa-folder-open nav_icon"></i>Thư Viện<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{url_site}/dashboard/library.html">Hình Ảnh</a>
                                </li>
                                <li>
                                    <a href="{url_site}/dashboard/library/files.html">Tài Liệu</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
