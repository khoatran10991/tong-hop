...
<?php if(isset($_GET['status']) && $_GET['status'] == "posted") : ?>
	<p class="alert alert-success"><i class="fa fa-check"></i> Thêm trang mới thành công. <a title="Xem '{page_name}'" target="_blank" href="<?php echo $url_site ?>/{page_url}.html">Xem trang</a></p>
<?php endif; ?>
<div class="xs">
						...
						<form class="form-horizontal" action="" method="post" >
									...
									<div class="row row-padding">
									      ...
									      <div class="content">
											<div class="form-group">
												<div class="col-sm-12">
													<input value="{page_name}" name="txt_title_page" type="text" class="form-control1" id="txt_title_page" placeholder="" style="font-weight: 500;font-size: 16px;">
												</div>
											...
											<div class="form-group">
												<div class="col-sm-12">			
													<textarea name="txt_content_page" id="txt_editor" class="form-control1">{page_content}</textarea>
												</div>
											...
											<div class="content">
												<div class="form-group">
													<div class="col-sm-12" style="min-height: 100px">
														...
														<div class="col-sm-10">
															<a class="" id="jnetseo_title">{page_name}</a>
															<span class="url" id="jnetseo_url"><?php echo $url_site ?>/<span id="return_url">{page_url}.html</span></span>
													...
													<div class="col-sm-12">	
														...
														<div class="col-sm-10">
															<input value="<?php echo $page_options['keyword'] ?>" name="txt_keywords_page" type="text" class="form-control1" id="focusedinput" placeholder="Từ Khóa - Keywords">
														</div>
													...
													<div class="col-sm-12">
														...
														<div class="col-sm-10">
															<textarea id="txt_metadescription_page" rows="3" name="txt_metadescription_page"  class="form-control"  placeholder="Thẻ Mô Tả Trang"><?php echo $page_options['description'] ?></textarea>
															<?php 
																$str = strlen($page_options['description']);
																$str_rest = 156 - $str;
															?>
								...
								<div class="col-sm-3">
									<div class="row row-padding">
										...
										<div class="content">
											<p class="post-item"><i class="fa fa-pencil"></i> Tình trạng: <b><?php echo $page_status; ?></b></p>
											<p class="post-item"><i class="fa fa-calendar"></i> Ngày đăng: <b>{time_created}</b></p>
											<input type="submit" class="btn btn-default" name="update_page_draft" value="Lưu bản nháp" >
											<input type="submit" class="btn btn-primary" name="update_page" value="Cập nhật" style="margin-left: 10px;">
										</div>
									</div>
									<div class="row row-padding">
										...
										<div class="content">
											<div class="form-group" style="margin:0px 0px 10px 0px">
											  ...
											  <select class="form-control" id="page_template" name="page_template">
											    <option value="default" <?php echo ($page_options['layout'] == "default" ? "selected" : "") ?>>Mặc định</option>
											    <option value="fullpage" <?php echo ($page_options['layout'] == "fullpage" ? "selected" : "") ?>>Full page</option>
											    <option value="sidebar" <?php echo ($page_options['layout'] == "sidebar" ? "selected" : "") ?>>With sidebar</option>
									...
									<div class="row row-padding">
										...
										<div class="content">
											<div class="form-group">
												<input name="imagethum" type="hidden" class="form-control1" id="imagethum" value="<?php echo $page_options['image'] ?>">
												<div style="margin-left:0px" title="Chọn ảnh" id="anhdaidien" onclick="openLibImages(this)" class="col-sm-12 col-sm-offset-2"><?php echo ($page_options['image'] != "" ? "<img src='".$page_options['image']."' class='img-responsive' />" : "Chọn Ảnh Đại Diện") ?></div>
											</div>
										</div>
									</div>
