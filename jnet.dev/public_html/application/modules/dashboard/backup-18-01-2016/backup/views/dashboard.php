<div class="col_3">
		       ...
		       <div class="activity_box">
		        <div class="scrollbar" id="style-2">
                   <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='template/backend/1/images/5.png' class="img-responsive" alt=""/></div>
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='template/backend/1/images/3.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='template/backend/1/images/1.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
                    ...
                    <div class="activity-row1">
	                 ...
	                 <div class="col-xs-3 activity-img"><img src='template/backend/1/images/4.png' class="img-responsive" alt=""/></div>
	                 <div class="col-xs-8 activity-desc">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  ...
		  <!----Calender -------->
			<link rel="stylesheet" href="template/backend/1/css/clndr.css" type="text/css" />
			<script src="template/backend/1/js/underscore-min.js" type="text/javascript"></script>
			<script src= "template/backend/1/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="template/backend/1/js/clndr.js" type="text/javascript"></script>
			<script src="template/backend/1/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="template/backend/1/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="template/backend/1/js/jquery.vmap.js"></script>
<script src="template/backend/1/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
<script src="template/backend/1/js/jquery.vmap.world.js" type="text/javascript"></script>
