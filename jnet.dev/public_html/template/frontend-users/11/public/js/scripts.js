...
$( document ).ready(function() {
			        ...
			        $('nav ul li a').each(function(){
			            ...
			            if(urlRegExp.test(this.href.replace(/\/$/,'')) && $(this).attr("href") != ''){
					...
					$(window).scroll(function() {
					    ...
					    if(scrollTop >= 200) {
							...
							$('#mobile-header').css({"position":"inherit"});
						}
					});
					
				
					$('img:not(.tr_all_long_hover)').each(function () {
						//alert($(this).attr('src'));
...
function addItemcart() {
		...
		$.post("gio-hang.html", {
				...
				if(data==1) {
					...
					// add html item 
					var html = '<li><div class="clearfix"><img style="width: 40px;height: 40px;" class="f_left m_right_10" src="'+ img +'" alt=""><div class="f_left product_description"><a href="#" class="color_dark m_bottom_5 d_block">'+ name + '</a></div><div class="f_left f_size_medium"><div class="clearfix">1 x <b class="color_dark">'+ price +'</b></div></div></div></li>';
