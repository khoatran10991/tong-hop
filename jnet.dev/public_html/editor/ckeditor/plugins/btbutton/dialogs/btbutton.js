                        ...
                        children: [
                            {
                                ...
                                setup: function (widget) {
                                    this.setValue(widget.data.text || 'Liên hệ ngay');
                                },
                                commit: function (widget) {
                                ...
                                children: [
                                    {
                                        ...
                                        '<p><a href="http://getbootstrap.com/components/#glyphicons" target="_blank" style="padding: 0px; vertical-align: top;">Danh sách icon</a></p><br/>' +
                                        '<p>Ví dụ: <em>glyphicon-pencil</em></p>'
                                    },
                                    {
                                        id: 'bsiconleft',
                                        type: 'text',
