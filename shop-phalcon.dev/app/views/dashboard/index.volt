...
<div class="content-top">
    ...
    <div class="col-md-8 content-top-2">
        ...
        <div class="content-graph">
            ...
            <!--graph-->
            <link rel="stylesheet" href="/backend/css/graph.css">
            <!--//graph-->
...
<div class="content-mid">
    ...
    <div class="col-md-5">
        ...
        <!----Calender -------->
        <link rel="stylesheet" href="/backend/css/clndr.css" type="text/css" />
        <script src="/backend/js/underscore-min.js" type="text/javascript"></script>
        <script src="/backend/js/moment-2.2.1.js" type="text/javascript"></script>
        <script src="/backend/js/clndr.js" type="text/javascript"></script>
        <script src="/backend/js/site.js" type="text/javascript"></script>
        <!----End Calender -------->
    </div>
    <div class="col-md-7 mid-content-top">
        <div class="middle-content">
            ...
            <div id="owl-demo" class="owl-carousel text-center">
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="/backend/images/na.jpg" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="/backend/images/na1.jpg" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="/backend/images/na2.jpg" alt="name">
                </div>
                <div class="item">
                    <img class="lazyOwl img-responsive" data-src="/backend/images/na.jpg" alt="name">
                </div>
    ...
    <div class="col-md-6 post-top">
        ...
        <div class="post-bottom">
            <div class="post-bottom-1">
                <a href="/backend/#"><i class="fa fa-facebook"></i></a>
                <p>15k <label>Likes</label></p>
            </div>
            <div class="post-bottom-2">
                <a href="/backend/#"><i class="fa fa-twitter"></i></a>
