            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="new-product-area">
                    <div class="left-title-area">
                        <h2 class="left-title">Mới cập nhật</h2>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="new-pro-carousel">
                                    <?php foreach ($product_fearture as $product) { ?>
                                        <!-- NEW-PRODUCT-SINGLE-ITEM START -->
                                        <div class="item">
                                            <div class="new-product">
                                                <div class="single-product-item">
                                                    <div class="product-image">
                                                        <a href="/<?php echo $product->link_product; ?>.html"><img src="<?php echo $this->escaper->escapeHtml($product->image_repersent); ?>" alt="product-image" /></a>
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <a href="/<?php echo $product->link_product; ?>.html"><?php echo $this->escaper->escapeHtml($product->name_product); ?></a>
                                                        <div class="price-box">
                                                            <span class="price"><?php echo number_format($product->price_product)?></span><span>đ</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="tab-bg-product-area">
                    ...
                    <div class="tab-carousel-menu">
                        <ul class="nav nav-tabs product-bg-nav">
                            <li class="active"><a href="#women-tab" data-toggle="tab">iphone</a></li>
                            <li><a href="#tops-tab" data-toggle="tab">samsung</a></li>
                            <li><a href="#t-shirts" data-toggle="tab">sony</a></li>
                        </ul>
                    </div>
                    <!-- TABS MENU END-->
                </div>
