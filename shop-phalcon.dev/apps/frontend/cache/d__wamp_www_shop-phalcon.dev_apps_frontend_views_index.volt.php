...
<!-- Mirrored from hastech.company/html/bstore-preview/bstore/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Mar 2016 08:52:32 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- BXSLIDER CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/jquery.bxslider.css'); ?>
    <!-- MEANMENU CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/meanmenu.min.css'); ?>
    <!-- JQUERY-UI-SLIDER CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/jquery-ui-slider.css'); ?>
    <!-- NIVO SLIDER CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/nivo-slider.css'); ?>
    <!-- OWL CAROUSEL CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/owl.carousel.css'); ?>
    <!-- OWL CAROUSEL THEME CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/owl.theme.css'); ?>
    <!-- BOOTSTRAP CSS
		============================================ -->
    ...
    <!-- IE CSS
		============================================ -->
    <?php echo $this->tag->stylesheetLink('css/css/ie.css'); ?>
    <!-- MODERNIZR JS
		============================================ -->
...
<!-- JS
		===============================================-->
<!-- jquery js -->
<?php echo $this->tag->javascriptInclude('js/vendor/jquery-1.11.3.min.js'); ?>

<!-- fancybox js -->
<?php echo $this->tag->javascriptInclude('js/jquery.fancybox.js'); ?>

<!-- bxslider js -->
<?php echo $this->tag->javascriptInclude('js/jquery.bxslider.min.js'); ?>

<!-- meanmenu js -->
<?php echo $this->tag->javascriptInclude('js/jquery.meanmenu.js'); ?>

<!-- owl carousel js -->
<?php echo $this->tag->javascriptInclude('js/owl.carousel.min.js'); ?>

<!-- nivo slider js -->
<?php echo $this->tag->javascriptInclude('js/jquery.nivo.slider.js'); ?>

<!-- jqueryui js -->
<?php echo $this->tag->javascriptInclude('js/jqueryui.js'); ?>

<!-- bootstrap js -->
<?php echo $this->tag->javascriptInclude('js/bootstrap.min.js'); ?>

<!-- wow js -->
<?php echo $this->tag->javascriptInclude('js/wow.js'); ?>
...
<!-- Mirrored from hastech.company/html/bstore-preview/bstore/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 14 Mar 2016 08:53:58 GMT -->
</html>