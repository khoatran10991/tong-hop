                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                ...
                                <div class="new-pro-carousel">
                                    {% for product in product_fearture %}
                                        <!-- NEW-PRODUCT-SINGLE-ITEM START -->
                                        <div class="item">
                                            <div class="new-product">
                                                <div class="single-product-item">
                                                    <div class="product-image">
                                                        <a href="/{{ product.link_product }}.html"><img src="{{ product.image_repersent|e }}" alt="product-image" /></a>
                                                    ...
                                                    <div class="product-info">
                                                        ...
                                                        <a href="/{{ product.link_product }}.html">{{ product.name_product|e }}</a>
                                                        <div class="price-box">
