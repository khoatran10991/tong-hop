...
<head>
    ...
    <!-- MEANMENU CSS
		============================================ -->
    {{ stylesheet_link('css/meanmenu.min.css') }}
    <!-- JQUERY-UI-SLIDER CSS
		============================================ -->
    {{ stylesheet_link('css/jquery-ui-slider.css') }}
    <!-- NIVO SLIDER CSS
		============================================ -->
    {{ stylesheet_link('css/nivo-slider.css') }}
    <!-- OWL CAROUSEL CSS
		============================================ -->
    ...
    <!-- IE CSS
		============================================ -->
    {{ stylesheet_link('css/css/ie.css') }}
    <!-- MODERNIZR JS
		============================================ -->
...
<!-- JS
		===============================================-->
<!-- jquery js -->
{{ javascript_include('js/vendor/jquery-1.11.3.min.js') }}

<!-- fancybox js -->
{{ javascript_include('js/jquery.fancybox.js') }}

<!-- bxslider js -->
{{ javascript_include('js/jquery.bxslider.min.js') }}

<!-- meanmenu js -->
{{ javascript_include('js/jquery.meanmenu.js') }}

<!-- owl carousel js -->
{{ javascript_include('js/owl.carousel.min.js') }}

<!-- nivo slider js -->
{{ javascript_include('js/jquery.nivo.slider.js') }}
