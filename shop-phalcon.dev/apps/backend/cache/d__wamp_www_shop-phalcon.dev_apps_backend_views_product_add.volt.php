...
<div style="padding: 10px" class="form-group container">
    ...
    <div class="col-sm-8">
        ...
        <div class="block-padding">
            <?php echo $this->tag->textField(array('name_product', 'class' => 'form-control tile-stats', 'placeholder' => 'Nhập tên sản phẩm...', 'required' => '')); ?>
            <?php echo $this->tag->textArea(array('content_product', 'id' => 'ckeditor', 'class' => 'form-control tile-stats', 'required' => '')); ?>
        </div>
        ...
        <div class="form-group block-padding">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-9">
                    <?php echo $this->tag->textArea(array('description_seo_product', 'class' => 'form-control tile-stats', 'placeholder' => 'Mô tả trang, tối ưu không quá 156 ký tự...')); ?>
                </div>
            </div>
    ...
    <div class="col-sm-4 ">
        <div class="row text-center block-padding">
            <?php echo $this->tag->submitButton(array('Lưu nháp', 'name' => 'status', 'class' => 'btn btn-default')); ?>
            <?php echo $this->tag->submitButton(array('Đăng sản phẩm', 'name' => 'status', 'class' => 'btn btn-primary')); ?>
        </div>
        <div class="form-group block-padding">
            <h5>Tổng quan</h5>
            <div class="col-sm-12">
                    <?php echo $this->tag->textField(array('sku_product', 'class' => 'form-control tile-stats', 'placeholder' => 'Mã sản phẩm')); ?>
            </div>
            <div class="col-sm-12">

                    <?php echo $this->tag->textField(array('price_product', 'class' => 'form-control tile-stats', 'placeholder' => 'Giá 1000.000.000')); ?>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="form-group block-padding">
